...
var Mundo5 = {
    preload:function (){
        game.load.image('mercadeo', '../img/componentes/navegacionMapa/bloqueJCampus.png');
    ...
    create:function(){
        ...
        popup2 = game.add.sprite(game.world.centerX, game.world.centerY, 'mercadeo');
        ...
        function iniciarNivel1(){
            navegacion.prototype.iniciarNivel("5-1");
        }
