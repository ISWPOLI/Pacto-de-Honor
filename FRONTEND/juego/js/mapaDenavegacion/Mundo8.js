...
var Mundo8 = {
    ...
    create:function(){
        ...
        popup2 = game.add.sprite(game.world.centerX, game.world.centerY, 'fcs');
        ...
        function iniciarNivel1(){
            navegacion.prototype.iniciarNivel("8-1");
        }
