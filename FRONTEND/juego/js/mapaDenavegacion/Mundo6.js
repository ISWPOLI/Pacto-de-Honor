...
//se le da una escala al popup cuando sale
    ...
    var nivelButton5 = game.add.button (180, 150, 'nivel6', null ,null,2, 1, 0);//En el null va la funcion de cambio de estado para el mundo 1 nivel 5

    nivelButton5.inputEnabled = true;
    nivelButton5.input.priorityID = 1;
    nivelButton5.input.useHandCursor = true;

 popup2.addChild(nivelButton5);
//se le da una escala al popup cuando sale
    popup2.scale.set(0.8);
