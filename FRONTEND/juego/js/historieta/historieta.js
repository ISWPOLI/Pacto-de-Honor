...
historieta.prototype = {
     ...
     create: function(){
         variablesHistorieta.music = game.add.audio('sonidos');
         variablesHistorieta.musicButton = game.add.audio('sonidoBoton');
         variablesHistorieta.music.loop = true;
         variablesHistorieta.music.play();
    ...
    verMapa: function(){
        ...
        variablesHistorieta.musicButton.play();
        variablesHistorieta.music.pause();
    },
    update: function(){
