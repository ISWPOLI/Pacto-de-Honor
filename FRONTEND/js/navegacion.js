var popup, popup2, popup3, popup4, popup5, popup6, popup7, popup8, popup9, popup10, popup11, popup12;
var btMundo, btMundo2, btMundo3, btMundo4, btMundo5, btMundo6, btMundo7, btMundo8, btMundo9, btMundo10, btMundo11, btMundo12;
var closeButton, closeButton2, closeButton3, closeButton4, closeButton5, closeButton6, closeButton7, closeButton8, closeButton9, closeButton10, closeButton11, closeButton12, botonCreditos;
var tween;

var navegacion = function(game){};
    navegacion.prototype = {
        preload: function() {
            game.load.spritesheet('btMundo2', 'assets/pause.png', 50,50);
            //fondo y escenarios
            game.load.image('fondo', 'assets/popupE/mapa.png');//Fondo            
            game.load.image('posGrados', 'assets/popupE/posGrados.png');//rdy
            game.load.image('medellin', 'assets/popupE/medellin.png');//rdy
            game.load.image('excelencia', 'assets/popupE/exe.png');//rdy
            game.load.image('paradero', 'assets/popupE/Paradero.png');//dy
            game.load.image('mercadeo', 'assets/popupE/fondoJ.png');//rdy cambiar imagen facultad mercadeo
            game.load.image('bloqueJ', 'assets/popupE/fondoJ.png');//rdy
            game.load.image('bienestar', 'assets/popupE/Bienestar.png');//rdy
            game.load.image('fcs', 'assets/popupE/fondoJ.png');//rdy falta imagen facultad ciencas sociales
            game.load.image('plazoleta', 'assets/popupE/Plazoleta.png');//rdy
            game.load.image('fca', 'assets/popupE/fondoJ.png');//rdy falta imagen facultad cieencias administrativas
            game.load.image('cancha', 'assets/popupE/Cancha.png');//rdy
            game.load.image('ing', 'assets/popupE/fondoJ.png');//dry falta imagen facultad ingenieria
            game.load.image('bloquei', 'assets/popupE/i.png');//rdy
            //botones
            game.load.spritesheet('nivel1', 'assets/nivel1.png', 192,71);
            game.load.spritesheet('nivel2', 'assets/nivel2.png', 192,71);
            game.load.spritesheet('nivel3', 'assets/nivel3.png', 192,71);
            game.load.spritesheet('nivel4', 'assets/nivel4.png', 192,71);
            game.load.spritesheet('nivel5', 'assets/nivel5.png', 192,71);
            game.load.spritesheet('botonCreditos', 'assets/botonCreditos.png', 62, 62);
            game.load.spritesheet('pause12', 'assets/pause12.png', 50,50);
            game.load.spritesheet('pause13', 'assets/pause13.png', 50,50);
            game.load.spritesheet('pause14', 'assets/pause14.png', 50,50);
            game.load.image('close', 'assets/orb.png');
        },
        
        //se agrega el fondo y se crean los botones de los mundos en donde tenemos button(x, y, nombre de la imagen, la funcion, sprites)
        create:function() {
        ...
        onMundo1 :function () {
            ...
            var nivelButton = game.add.button (180, -250, 'nivel1', verBatalla, null, 2, 1, 0);//En el null va la funcion de cambio de estado para el mundo 1 nivel 1
