...
var namesCharacters = ["Ana Pantera", "Andres Gallo", "Cata Cierva", "Daniela Jirafa", "Daniel León", "Fabian Canario", "Iván Ruiseñor", "Pedro Raton", "Tati Hormiga"];
var description;
var apodo;
var startButton;
...
seleccionavatar.prototype = {
     preload: function(){
          ...
          game.load.image('pantera', 'images/AnaPantera.png');
          game.load.image('gallo', 'images/AndresGallo.png');
          game.load.image('cierva', 'images/CataCierva.png');
          game.load.image('girafa', 'images/DanielaGirafa.png');
          game.load.image('leon', 'images/DanielLeon.png');
          game.load.image('canario', 'images/FabianCanario.png');
          game.load.image('ruisenor', 'images/IvanRuisenor.png');
          game.load.image('raton', 'images/PedroRaton.png');
          game.load.image('hormiga', 'images/TatiHormiga.png');
