...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && ( get_theme_mod( 'index_feat_image' ) != 1 ) ) : ?>
		<div class="entry-thumb">
			...
			<a class="thumb-link" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><i class="fa fa-link"></i></a>		
		</div>	
	<?php endif; ?>	
	...
	<?php endif; ?>		
		...
		<div class="entry-content">
			...
			<?php
				wp_link_pages( array(
					'before' => '<div class="page-links">' . __( 'Pages:', 'paraxis-lite' ),
					'after'  => '</div>',
				) );
			?>
		</div><!-- .entry-content -->
	...
	<div class="read-more">
		<a href="<?php the_permalink(); ?>"><?php echo __('Read more','paraxis-lite'); ?></a>
	</div>		
	<?php endif; ?>
