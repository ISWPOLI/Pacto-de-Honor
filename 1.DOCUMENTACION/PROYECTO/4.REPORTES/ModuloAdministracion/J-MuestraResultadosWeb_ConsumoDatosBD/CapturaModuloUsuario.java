...
public class CapturaModuloUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            while(res.next())
            {
                out.print(" Id_usuario: "+res.getString(1)+" Id pais: "+res.getString(2)+" Id ciudad: "+res.getString(3)+"Id rol usuario: "+res.getString(4)+" Nombre usuario: "+res.getString(5)+" Apellido usuario: "+res.getString(6)+" Email usuario: "+res.getString(7)+" Contraseña usuario: "+res.getString(8)+" Fecha Registro: "+res.getString(9)+" Token: "+res.getString(10)+" Fecha token: " +res.getString(11)+ "<br />");
                out.print("<br />");
            }
