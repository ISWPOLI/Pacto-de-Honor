...
public class TipoPruebaFacadeREST extends AbstractFacade<TipoPrueba> {
    ...
    public void create(TipoPrueba entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, TipoPrueba entity) {
        super.edit(entity);
    }
    ...
    public TipoPrueba find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<TipoPrueba> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
