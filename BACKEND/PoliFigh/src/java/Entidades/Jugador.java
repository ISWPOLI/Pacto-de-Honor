 ...
 */
@Entity
@Table(name = "jugador", catalog = "p_h01", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Jugador implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "moneda_jugador", nullable = false)
    private int monedaJugador;
    @Basic(optional = false)
    @NotNull
    @Column(name = "experiencia_jugador", nullable = false)
    private int experienciaJugador;
    @Basic(optional = false)
    @NotNull
    @Column(name = "nivel_jugador", nullable = false)
    private int nivelJugador;
    @JoinTable(name = "jugador_tiene_personaje", joinColumns = {
        @JoinColumn(name = "id_jugador", referencedColumnName = "id_jugador", nullable = false)}, inverseJoinColumns = {
