 ...
 */
@Entity
@Table(name = "nivel", catalog = "p_h01", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Nivel implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 20)
    @Column(name = "nombre_nivel", nullable = false, length = 20)
    private String nombreNivel;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "nivel")
    private List<Jugador> jugadorList;
    @JoinColumn(name = "id_mundo", referencedColumnName = "id_mundo", nullable = false, insertable = false, updatable = false)
