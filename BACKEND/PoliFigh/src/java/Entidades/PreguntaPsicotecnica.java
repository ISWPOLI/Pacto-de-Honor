 ...
 */
@Entity
@Table(name = "pregunta_psicotecnica", catalog = "p_h01", schema = "")
@XmlRootElement
@NamedQueries({
...
public class PreguntaPsicotecnica implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "descripcion_prueba_psicotecnica", length = 255)
    private String descripcionPruebaPsicotecnica;
    @JoinTable(name = "prueba_tiene_pregunta", joinColumns = {
        @JoinColumn(name = "id_pregunta_psicotecnica", referencedColumnName = "id_pregunta_psicotecnica", nullable = false)}, inverseJoinColumns = {
        @JoinColumn(name = "id_prueba_psicotecnica", referencedColumnName = "id_prueba_psicotecnica", nullable = false)})
    @ManyToMany
    private List<PruebaPsicotecnica> pruebaPsicotecnicaList;
    @JoinColumn(name = "id_respuesta_psicotecnica", referencedColumnName = "id_respuesta_psicotecnica", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private RespuestaPsicotecnica respuestaPsicotecnica;
    @JoinColumn(name = "id_tipo_pregunta_psicotecnica", referencedColumnName = "id_tipo_pregunta_psicotecnica", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    @XmlTransient
    public List<PruebaPsicotecnica> getPruebaPsicotecnicaList() {
        return pruebaPsicotecnicaList;
    }

    public void setPruebaPsicotecnicaList(List<PruebaPsicotecnica> pruebaPsicotecnicaList) {
        this.pruebaPsicotecnicaList = pruebaPsicotecnicaList;
    }
