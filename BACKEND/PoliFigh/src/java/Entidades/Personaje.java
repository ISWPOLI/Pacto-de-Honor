 ...
 */
@Entity
@Table(name = "personaje", catalog = "p_h01", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Personaje implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 20)
    @Column(name = "nombre_personaje", nullable = false, length = 20)
    private String nombrePersonaje;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 255)
    @Column(name = "descripcion_personaje", nullable = false, length = 255)
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "nivel_dano", nullable = false)
    ...
    @JoinTable(name = "personaje_tiene_poder", joinColumns = {
        @JoinColumn(name = "id_personaje", referencedColumnName = "id_personaje", nullable = false)}, inverseJoinColumns = {
        @JoinColumn(name = "id_poder", referencedColumnName = "id_poder", nullable = false)})
    @ManyToMany
