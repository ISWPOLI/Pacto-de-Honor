 ...
 */
@Entity
@Table(name = "poder", catalog = "p_h01", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Poder implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 20)
    @Column(name = "nombre_poder", nullable = false, length = 20)
    private String nombrePoder;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 255)
    @Column(name = "descripcion_poder", nullable = false, length = 255)
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "forma_poder", nullable = false)
    private int formaPoder;
    @Basic(optional = false)
    @NotNull
    @Column(name = "potencia_poder", nullable = false)
    ...
    public String toString() {
        return "Entidades.Poder[ poderPK=" + poderPK + " ]";
    }
