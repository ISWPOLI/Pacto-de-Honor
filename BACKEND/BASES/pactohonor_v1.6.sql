...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2017 a las 17:02:12
...
--
-- Estructura de tabla para la tabla `codigos_alfanumericos`
--

CREATE TABLE `codigos_alfanumericos` (
  `id_codigos_alfanumericos` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `codigos_alfanumericos`
--

INSERT INTO `codigos_alfanumericos` (`id_codigos_alfanumericos`, `fecha_creacion`, `vigencia`, `usado`, `codigo`) VALUES
(1, '2017-05-11', 10, b'0', '5DASDFFASD'),
(2, '2017-05-27', 10, b'0', '30FAB-QNQOE'),
(3, '2017-05-27', 10, b'0', '4NDFG-CGBLE'),
(4, '2017-05-27', 10, b'0', '12TVE-DEQLE'),
(5, '2017-05-27', 10, b'0', '7WCVT-IVZPE'),
(6, '2017-05-27', 10, b'0', '52835-OV6YE'),
(7, '2017-05-27', 10, b'0', '6PHLG-BTG6E'),
(8, '2017-05-27', 10, b'0', '7H6G6-R24IE'),
(9, '2017-05-27', 10, b'0', '1405H-VPYCE'),
(10, '2017-05-27', 10, b'0', '3P76L-4SH5E'),
(11, '2017-05-27', 10, b'0', '6DZE6-XFKZE'),
(12, '2017-05-27', 10, b'0', '6TYPG-LYDZE'),
(13, '2017-05-27', 10, b'0', '83OKG-92LGE');
...
--
-- Estructura de tabla para la tabla `jugador_tiene_amigos`
--
...
CREATE TABLE `mensaje` (
  ...
  `id_jugador_from` int(11) NOT NULL,
  `id_jugador_to` int(11) NOT NULL,
  `mensaje` varchar(5000) COLLATE utf8_spanish_ci DEFAULT NULL,
  `isChat` bit(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Volcado de datos para la tabla `personaje_tiene_imagen`
--
...
CREATE TABLE `pregunta_prueba_psicotecnica` (
  ...
  `numero_pregunta_prueba` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `pregunta_prueba_psicotecnica`
--

INSERT INTO `pregunta_prueba_psicotecnica` (`id_pregunta_psicotecnica`, `id_prueba_psicotecnica`, `pregunta`, `id_tipo_pregunta_psicotecnica`, `numero_pregunta_prueba`) VALUES
(00000000001, 1, 'Me gustan leer los artículos sobre crímenes en los periodicos.', 1, 7),
(00000000002, 1, 'Por principio, cuando alguien me hace algún mal siento que, de ser posible, deberia pagarle con la misma moneda.', 1, 27),
(00000000003, 1, 'En ocasiones siento deseos de maldecir.', 1, 29),
(00000000004, 1, 'Creo que la mayoría de la gente metiría para salir adelante.', 1, 81),
(00000000005, 1, 'Cuando joven me suspendieron de la escuela una o más veces por mala conducta.', 1, 84),
(00000000006, 1, 'Nunca he hecho algo peligroso sólo por el gusto de hacerlo.', 1, 100),
(00000000007, 1, 'Disfruto más de una carrera o de un juego cuando apuesto.', 1, 103),
(00000000008, 1, 'La mayor parte de la gente es honrada principalmente por temor a ser descubierta.', 1, 104),
(00000000009, 1, 'En la escuela algunas veces me llevaron ante el director por mala conducta.', 1, 105),
(00000000010, 1, 'Si pudiera entrar a un cine sin pagar y estuviera seguro de no ser descubierto, probablemente lo haría.', 1, 123),
(00000000011, 1, 'Me gusta la ciencia.', 1, 199),
(00000000012, 1, 'A mendo mis padres se oponían a la clase de gente que frecuentaba.', 1, 202),
(00000000013, 1, 'Fui una persona lenta para aprender en la escuela.', 1, 235),
(00000000014, 1, 'Nunca he tenido problemas con la ley.', 1, 266),
(00000000015, 1, 'Si varias personas se hallan en apuros, lo mejor que pueden hacer es ponerse de acuerdo sobre lo que van a decir y mantenerse firmes en lo que acuerden.', 1, 269),
(00000000016, 1, 'La persona que causa tentación dejando propiedades de valor sin protección, es tan culpable del robo como el ladrón.', 1, 283),
(00000000017, 1, 'Creo que casi todo el mundo mentiría para evitarse problemas.', 1, 284),
(00000000018, 1, 'La mayoría de las personas utilizaría medios, de alguna manera discutibles, para mejorar su situación en la vida.', 1, 374),
(00000000019, 1, 'Cuando era chico(a) frecuentemente no iba a la escuela aunque debía haberlo hecho.', 1, 412),
(00000000020, 1, 'Es correcto tratar de evitar el cumplimiento de la ley, siempre que ésta no se viole.', 1, 418),
(00000000021, 1, 'Hay ciertas personas que me desagradan tanto, que me alegro interiormente cuando están pagando las consecuencias por algo que han hecho.', 1, 419),
(00000000022, 1, 'En la escuela mis calificaciones en conducta general eran malas.', 1, 431);
...
--
-- Volcado de datos para la tabla `prueba_psicotecnica`
--

INSERT INTO `prueba_psicotecnica` (`id_prueba_psicotecnica`, `nombre`, `fecha_creacion`, `id_tipo_prueba`) VALUES
(1, 'MMPIA', '2017-04-01 05:00:00', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `prueba_psicotecnica_factores`
--

CREATE TABLE `prueba_psicotecnica_factores` (
  `id_factor` int(11) NOT NULL,
  `sigla` varchar(5) COLLATE utf8_spanish_ci NOT NULL,
  `nombre_factor` text COLLATE utf8_spanish_ci NOT NULL,
  `puntos_totales` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `prueba_psicotecnica_factores`
--

INSERT INTO `prueba_psicotecnica_factores` (`id_factor`, `sigla`, `nombre_factor`, `puntos_totales`) VALUES
(1, 'PAS', 'Prácticas Antisociales', 13),
(2, 'RS', 'Responsabilidad Social', 14);
...
--
-- Volcado de datos para la tabla `respuesta_preguntas_psicotecnicas`
--

INSERT INTO `respuesta_preguntas_psicotecnicas` (`id_pregunta_prueba_psicotecnica`, `id_respuesta_psicotecnica`, `descripcion_prueba_psicotecnica`, `id_factor`) VALUES
(1, 2, 'FALSO', 2),
(1, 3, 'NULL', 1),
(2, 4, 'FALSO', 2),
(2, 5, 'NULL', 1),
...
--
-- Estructura de tabla para la tabla `respuesta_prueba_jugador`
--
...
--
-- Volcado de datos para la tabla `tipo_pregunta_psicotecnica`
--

INSERT INTO `tipo_pregunta_psicotecnica` (`id_tipo_pregunta_psicotecnica`, `clase_pregunta`) VALUES
(1, 1);
...
INSERT INTO `tipo_prueba` (`id_tipo_prueba`, `tipo_prueba`, `descripcion_tipo_prueba`) VALUES
(1, 'TEST', 'tipo de prueba desarrollada para completar los datos');
...
INSERT INTO `usuario` (`id_usuario`, `id_pais`, `id_ciudad`, `id_rol_usuario`, `nombre_usuario`, `apellido_usuario`, `email_usuario`, `contrasena_usuario`, `fecha_registro`, `token`, `fecha_token`, `usuario`) VALUES
(1, 1, 1, 1, 'Estudiante', 'Demo', 'usuario@poligran.edu.co', 'demo123', '2017-03-04 15:20:16', 'B7D7F7BECE904F5394BEE4796F4B2497100517210745', '2017-05-10 21:07:45 ', 'Estudiante'),
(2, 1, 52838, 1, 'Juan', 'Rubiano', 'jnrubiano@poligran.edu.co', '1234567890', '2017-04-15 23:28:47', '962C7B2EBEB246ACB132C4BAA90E52E6170417155119', '2017-04-17 15:51:19 ', 'jnrubiano');
...
--
-- Indices de la tabla `codigos_alfanumericos`
--
ALTER TABLE `codigos_alfanumericos`
  ADD PRIMARY KEY (`id_codigos_alfanumericos`),
  ADD UNIQUE KEY `id_codigos_alfanumericos` (`id_codigos_alfanumericos`) USING BTREE;
...
--
-- Indices de la tabla `jugador_tiene_amigos`
--
...
ALTER TABLE `pregunta_prueba_psicotecnica`
  ADD PRIMARY KEY (`id_pregunta_psicotecnica`);

--
-- Indices de la tabla `prueba_psicotecnica`
--
ALTER TABLE `prueba_psicotecnica`
  ADD PRIMARY KEY (`id_prueba_psicotecnica`),
  ADD KEY `fk_tipo_prueba1_idx` (`id_tipo_prueba`),
  ADD KEY `id_prueba_psicotecnica` (`id_prueba_psicotecnica`);

--
-- Indices de la tabla `prueba_psicotecnica_factores`
--
ALTER TABLE `prueba_psicotecnica_factores`
...
--
-- Indices de la tabla `respuesta_prueba_jugador`
--
...
--
-- AUTO_INCREMENT de la tabla `codigos_alfanumericos`
--
ALTER TABLE `codigos_alfanumericos`
  MODIFY `id_codigos_alfanumericos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- AUTO_INCREMENT de la tabla `jugador_tiene_amigos`
--
ALTER TABLE `jugador_tiene_amigos`
  MODIFY `Id_jugador_amigo` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jugador_tiene_personaje`
--
ALTER TABLE `jugador_tiene_personaje`
...
--
-- AUTO_INCREMENT de la tabla `mundo_tiene_imagen`
--
ALTER TABLE `mundo_tiene_imagen`
...
--
ALTER TABLE `pregunta_prueba_psicotecnica`
  MODIFY `id_pregunta_psicotecnica` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT de la tabla `prueba_psicotecnica`
--
ALTER TABLE `prueba_psicotecnica`
  MODIFY `id_prueba_psicotecnica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `prueba_psicotecnica_factores`
--
ALTER TABLE `prueba_psicotecnica_factores`
  MODIFY `id_factor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `respuesta_preguntas_psicotecnicas`
--
ALTER TABLE `respuesta_preguntas_psicotecnicas`
  MODIFY `id_respuesta_psicotecnica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
-- AUTO_INCREMENT de la tabla `respuesta_prueba_jugador`
--
ALTER TABLE `respuesta_prueba_jugador`
...
--
ALTER TABLE `tipo_pregunta_psicotecnica`
  MODIFY `id_tipo_pregunta_psicotecnica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tipo_prueba`
--
ALTER TABLE `tipo_prueba`
  MODIFY `id_tipo_prueba` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
