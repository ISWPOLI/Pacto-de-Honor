...
INSERT INTO `jugador_tiene_personaje` (`id_jugador`, `id_personaje`, `id_Jugador_tiene_personaje`) VALUES
(1, 14, 1),
(1, 20, 2);
...
ALTER TABLE `personaje_tiene_imagen`
  MODIFY `id_personaje_tiene_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `poder`
