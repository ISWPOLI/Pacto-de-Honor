...
import co.edu.poli.entidades.Log;
import co.edu.poli.entidades.LogPK;
...
public class LogFacadeREST extends AbstractFacade<Log> {
    ...
    private LogPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.LogPK key = new co.edu.poli.entidades.LogPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.LogPK key = getPrimaryKey(id);
