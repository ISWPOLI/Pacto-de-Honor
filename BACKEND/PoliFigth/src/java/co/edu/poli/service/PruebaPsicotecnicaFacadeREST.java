...
import co.edu.poli.entidades.PruebaPsicotecnica;
 ...
 */
@Stateless
@Path("entidades.pruebapsicotecnica")
public class PruebaPsicotecnicaFacadeREST extends AbstractFacade<PruebaPsicotecnica> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, PruebaPsicotecnica entity) {
        super.edit(entity);
    }
    ...
    public PruebaPsicotecnica find(@PathParam("id") Integer id) {
