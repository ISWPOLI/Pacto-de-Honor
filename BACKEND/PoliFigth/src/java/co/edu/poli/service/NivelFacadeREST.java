...
import co.edu.poli.entidades.Nivel;
import co.edu.poli.entidades.NivelPK;
...
public class NivelFacadeREST extends AbstractFacade<Nivel> {
    ...
    private NivelPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.NivelPK key = new co.edu.poli.entidades.NivelPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.NivelPK key = getPrimaryKey(id);
