...
import co.edu.poli.entidades.Usuario;
import co.edu.poli.entidades.UsuarioPK;
...
public class UsuarioFacadeREST extends AbstractFacade<Usuario> {
    ...
    private UsuarioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.UsuarioPK key = new co.edu.poli.entidades.UsuarioPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.UsuarioPK key = getPrimaryKey(id);
