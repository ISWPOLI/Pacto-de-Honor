...
import co.edu.poli.entidades.Poder;
import co.edu.poli.entidades.PoderPK;
...
public class PoderFacadeREST extends AbstractFacade<Poder> {
    ...
    private PoderPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.PoderPK key = new co.edu.poli.entidades.PoderPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.PoderPK key = getPrimaryKey(id);
