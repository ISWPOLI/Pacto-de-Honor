...
import co.edu.poli.entidades.Personaje;
import co.edu.poli.entidades.PersonajePK;
...
public class PersonajeFacadeREST extends AbstractFacade<Personaje> {
    ...
    private PersonajePK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.PersonajePK key = new co.edu.poli.entidades.PersonajePK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.PersonajePK key = getPrimaryKey(id);
