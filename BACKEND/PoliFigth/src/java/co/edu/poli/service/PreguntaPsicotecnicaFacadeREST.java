...
import co.edu.poli.entidades.PreguntaPsicotecnica;
import co.edu.poli.entidades.PreguntaPsicotecnicaPK;
...
public class PreguntaPsicotecnicaFacadeREST extends AbstractFacade<PreguntaPsicotecnica> {
    ...
    private PreguntaPsicotecnicaPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.edu.poli.entidades.PreguntaPsicotecnicaPK key = new co.edu.poli.entidades.PreguntaPsicotecnicaPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.edu.poli.entidades.PreguntaPsicotecnicaPK key = getPrimaryKey(id);
