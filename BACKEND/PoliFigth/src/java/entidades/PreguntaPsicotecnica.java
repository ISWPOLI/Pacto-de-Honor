...
public class PreguntaPsicotecnica implements Serializable {
    ...
    @JoinTable(name = "prueba_tiene_pregunta", joinColumns = {
        @JoinColumn(name = "id_pregunta_psicotecnica", referencedColumnName = "id_pregunta_psicotecnica")}, inverseJoinColumns = {
        @JoinColumn(name = "id_prueba_psicotecnica", referencedColumnName = "id_prueba_psicotecnica")})
    @ManyToMany
