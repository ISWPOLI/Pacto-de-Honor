...
// Model for Usuario entity
    models.Usuario = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/Restful.PH/webresources/com.usuario.restful.ph.usuario/",
        defaults: {
            apellidoUsuario: "",
            contrasenaUsuario: "",
            emailUsuario: "",
        ...
        toViewJson: function() {
            ...
            result.displayName = this.get('apellidoUsuario');
            return result;
        },
        isNew: function() {
        ...
        sync: function(method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/Restful.PH/webresources/com.usuario.restful.ph.usuario/';
            }
    ...
    models.UsuarioCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/Restful.PH/webresources/com.usuario.restful.ph.usuario/",
        sync: function(method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function(jqXHR, textStatus, errorThrown) {
